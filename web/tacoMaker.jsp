            ...
            <form method="POST" action="createOrderServlet">
                ...
                <div class="form-group row">
                    ...
                    <select class="col-md-4" name="tacotype">
                        ...
                        <option value="Camaron guisado">Camarón guisado</option>
                        <option value="Camaron empanizado">Camarón empanizado</option>
                        <option value="Filete pescado">Filete de pescado</option>
                        <option value="Chile relleno de marlin">Chile relleno de marlín</option>
                    </select>
                </div>
                <div class="form-group row">
